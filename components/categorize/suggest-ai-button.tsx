// Scaffold only. A dumb, presentational button — all fetch/state ownership
// lives in categorize-view.tsx per its existing pattern (confirm/skip are
// owned by the parent too, rows just call back up).
'use client';
...
export const SuggestAiButton = ({
  ...
  return (
    <>
      ...
      >
        {/* Sparkles icon from lucide-react; Loader2 + animate-spin while loading, per Button's own idiom */}
